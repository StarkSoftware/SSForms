...
public class ImageMultiplePickerAdapter extends RecyclerView.Adapter<ImageMultiplePickerAdapter.ImageViewHolder> {
    ...
    public ImageMultiplePickerAdapter(Context context, List<Image> selectedImages, OnImageClickListener itemClickListener) {
