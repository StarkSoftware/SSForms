...
public class SignaturePickerConfig implements Parcelable {
    ...
    public SignaturePickerConfig(Context context) {
    ...
    protected SignaturePickerConfig(Parcel in) {
    ...
    public static final Creator<SignaturePickerConfig> CREATOR = new Creator<SignaturePickerConfig>() {
        @Override
        public SignaturePickerConfig createFromParcel(Parcel source) {
            return new SignaturePickerConfig(source);
        }

        @Override
        public SignaturePickerConfig[] newArray(int size) {
            return new SignaturePickerConfig[size];
        }
    };
}
