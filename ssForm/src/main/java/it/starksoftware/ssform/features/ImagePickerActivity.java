...
import it.starksoftware.ssform.features.camera.CameraHelper;
import it.starksoftware.ssform.helper.ImagePickerPreferences;
import it.starksoftware.ssform.helper.IntentHelper;
import it.starksoftware.ssform.helper.ViewUtils;
import it.starksoftware.ssform.listeners.OnFolderClickListener;
...
import it.starksoftware.ssform.view.ProgressWheel;
import it.starksoftware.ssform.view.SnackBarView;
...
import static it.starksoftware.ssform.features.ImagePicker.MODE_SINGLE;
import static it.starksoftware.ssform.helper.ImagePickerPreferences.PREF_WRITE_EXTERNAL_STORAGE_REQUESTED;
