package it.starksoftware.ssform.StarkSpinner;
...
import it.starksoftware.ssform.StarkSpinner.Interfaces.IStatusListener;
import it.starksoftware.ssform.StarkSpinner.Interfaces.OnItemSelectedListener;
import it.starksoftware.ssform.StarkSpinner.Tools.EditCursorColor;
import it.starksoftware.ssform.StarkSpinner.Tools.UITools;


public class StarkSpinner extends RelativeLayout implements View.OnClickListener {
    ...
    public StarkSpinner(@NonNull Context context) {
        this(context, null);
    }

    public StarkSpinner(@NonNull Context context, @Nullable AttributeSet attrs) {
